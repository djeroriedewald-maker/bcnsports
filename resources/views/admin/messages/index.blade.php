...
@section('content')
    <div class="mb-8 flex justify-between items-center">
        ...
        <a href="{{ route('admin.messages.export', request()->only('status')) }}" class="bg-bcn-gray border border-white/10 text-white font-medium px-4 py-2 rounded-lg hover:bg-white/5 transition inline-flex items-center">
